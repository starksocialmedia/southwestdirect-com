...
A11Y_BODY = f'''<main>
  ...
  <div class="prose">
    ...
    <ul>
      ...
      <li><strong>Landmark regions</strong> — header, navigation, main and footer — that let assistive technology jump straight to the main content without stepping through the menu</li>
